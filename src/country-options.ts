// Static English labels keep country selection compatible with native runtimes
// that do not implement Intl.DisplayNames. Calling codes follow libphonenumber-js.
